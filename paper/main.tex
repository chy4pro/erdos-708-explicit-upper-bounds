...
elementary sieve lemma for intervals), $g(n)\le\bigl(17+149e\ln(1+\ln(8n^3))\bigr)n=O(n\ln\ln n)$. We also show that the conjectured bound holds for long
...
$g(n)\le(17+149e\ln(1+\ln(8n^3)))n=O(n\ln\ln n)$ (Corollary~\ref{cor:lnln}), an improvement of Theorem~\ref{thm:sqrt} in the
order of growth (though not numerically below astronomically large $n$).
...
were chosen for simplicity. The bound of Corollary~\ref{cor:lnln} is smaller than that of Theorem~\ref{thm:sqrt} only for
astronomically large $n$; its point is the order of growth. The hinge inequality with threshold $2$ (Conjecture~\ref{conj:TH}),
