...
explicit counting certificates, while the fractional case, which would give $g(n)=O(n)$, remains open. We also show that the conjectured bound holds for long
...
bound of Theorem~\ref{thm:sqrt} for every $n$.
