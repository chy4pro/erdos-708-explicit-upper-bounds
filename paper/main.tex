...
elementary sieve lemma for intervals), $g(n)\le\bigl(16+20\ln\ln(8n^3)\bigr)n=O(n\ln\ln n)$. We also show that the conjectured bound holds for long
...
(Theorem~\ref{thm:A}). Section~\ref{sec:fractional} extends this to arbitrary weights
